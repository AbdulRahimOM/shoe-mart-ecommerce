...
type User struct {
	...
	Password      string    `json:"-" gorm:"column:password;notNull"`
	Status        string    `json:"status" gorm:"default:Pending;notNull"`
	CreatedAt     time.Time `json:"-" gorm:"column:created_at;notNull"`
	WalletBalance float32   `json:"walletBalance" gorm:"column:wallet_balance;notNull;default:0"`
}
