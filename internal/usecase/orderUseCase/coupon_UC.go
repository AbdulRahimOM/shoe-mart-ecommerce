...
// CreateNewCoupon
func (uc *OrderUseCase) CreateNewCoupon(req *request.NewCouponReq) (string, error) {
...
// BlockCoupon
func (uc *OrderUseCase) BlockCoupon(req *request.BlockCouponReq) (string, error) {
...
// UnblockCoupon
func (uc *OrderUseCase) UnblockCoupon(req *request.UnblockCouponReq) (string, error) {
