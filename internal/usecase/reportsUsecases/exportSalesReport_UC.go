...
func (uc *ReportsUseCase) ExportSalesReportFullTime() (string, error) {
	...
	// Save the Excel file locally (for dev/testing purposes)
...
func (uc *ReportsUseCase) ExportSalesReportLastMonth() (string, error) {
	...
	orderList, sellerWiseReport, brandWiseReport, modelWiseReport, sizeWiseReport, revenueGraph, err := uc.reportsRepo.GetSalesReportBetweenDates(start, end)
	if err != nil {
		fmt.Println("Error getting sales report:", err)
		return "", err
	}
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "lastMonthReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportLastWeek() (string, error) {
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "lastWeekReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportLastYear() (string, error) {
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "lastYearReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportThisMonth() (string, error) {
	...
	orderList, sellerWiseReport, brandWiseReport, modelWiseReport, sizeWiseReport, revenueGraph, err := uc.reportsRepo.GetSalesReportBetweenDates(start, now)
	if err != nil {
		fmt.Println("Error getting sales report:", err)
		return "", err
	}
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "thisMonthReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportThisWeek() (string, error) {
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "thisWeekReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportThisYear() (string, error) {
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "thisYearReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportYesterday() (string, error) {
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "yesterdayReportForAdmin",
				Overwrite: true,
			},
		}
...
func (uc *ReportsUseCase) ExportSalesReportBetweenDates(startDate time.Time, endDate time.Time) (string, error) {
	...
	orderList, sellerWiseReport, brandWiseReport, modelWiseReport, sizeWiseReport, revenueGraph, err := uc.reportsRepo.GetSalesReportBetweenDates(startDate, endDate)
	if err != nil {
		fmt.Println("Error getting sales report:", err)
		return "", err
	}
	...
	if os.Getenv("UPLOAD_EXCEL") == "true" {
		var excelUploadReq requestModels.ExcelFileReq = requestModels.ExcelFileReq{
			...
			UploadParams: uploader.UploadParams{
				Folder:    "MyShoo/adminreports",
				PublicID:  "customRangeReportForAdmin",
				Overwrite: true,
			},
		}
